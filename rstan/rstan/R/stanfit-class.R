...
if (!isGeneric("high_five")) {
  setGeneric(name = "high_five",
             def = function(object, ...) { standardGeneric("high_five") })
}

setMethod("high_five", signature = "stanfit",
          function(object, upars, adjust_transform = TRUE) {
            ...
            print("High fives!!!  55555")
            object@.MISC$stan_fit_instance$high_five(upars, adjust_transform)
          })
# setMethod("high_five", signature = "stanfit",
#           function(object, pars) {
...
#               stop("the model object is not created or not valid")
#             print("High fives!!!  55555")
#             object@.MISC$stan_fit_instance$high_five(pars)
#           })
